          ...
          <div className="flex justify-between items-center h-16 sm:h-20">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-gray-500">Edit Course - {user.name}</p>
              </div>
              <div className="sm:hidden">
                <span className="text-gray-900 font-bold text-base">Edit Course</span>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-blue-200 rounded-t-xl p-4 sm:p-6 lg:p-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-2">Edit Course</h1>
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="text-blue-600 font-semibold bg-blue-50 px-3 py-1 rounded-full text-xs sm:text-sm flex items-center gap-1 sm:gap-2">
                    <i className="fas fa-tag text-xs sm:text-sm"></i>
                    {course?.category || "Category"}
                  </span>
                  <span className="text-green-600 font-semibold bg-green-50 px-3 py-1 rounded-full text-xs sm:text-sm flex items-center gap-1 sm:gap-2">
                    <i className="fas fa-chart-line text-xs sm:text-sm"></i>
                    {formData.courseLevel || "Select Level"}
                  </span>
                </div>
              </div>
              <div className="text-sm sm:text-base text-gray-600">
                <i className="fas fa-info-circle text-blue-600 mr-1"></i>
                Update course details for students
              </div>
            </div>
          </div>
